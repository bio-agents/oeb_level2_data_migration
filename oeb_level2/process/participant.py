...
class ParticipantConfig:
    ...
    def FromDataset(cls, participant_ql: "Mapping[str, Any]") -> "ParticipantConfig":
        ...
        return cls(
            agent_id=participant_ql["depends_on"]["agent_id"],
...
class ParticipantBuilder():
    ...
    def build_participant_dataset(
        ...
        agent_mapping: "Mapping[Optional[str], ParticipantConfig]",
        ...
        for min_participant_data in min_participant_dataset:
            ...
            p_config = agent_mapping.get(min_participant_data["participant_id"])
            # Default case
            if p_config is None:
                if len(agent_mapping) > 1 or (None not in agent_mapping):
            ...
            # add dataset dependencies: agent and reference datasets
            list_oeb_datasets = []
    ...
    def build_test_events(self, valid_participant_tuples: "Sequence[ParticipantTuple]", indexed_challenges: "Mapping[str, IndexedChallenge]") -> "Sequence[Mapping[str, Any]]":
        ...
        for pt in valid_participant_tuples:
            ...
            for challenge_pair in pt.challenge_pairs:
                ...
                event["agent_id"] = pt.participant_dataset["depends_on"]["agent_id"]
